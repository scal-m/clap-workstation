...
package com.ryanberdeen.soundtouch {
    ...
    public class SimpleFilter extends FilterSupport {
        ...
        override protected function fillInputBuffer(numFrames:int):void {
         	//trace ("source : " + _sourcePosition);
         	//trace ("milli : " + sourceSound.length);
         	//trace ("numFrames : " + numFrames);
        	//trace ("bytes : " + sourceSound.bytesTotal);
        	//trace ("outputbuffer : " + this.outputBuffer.frameCount);
...
/*         override protected function fillOutputBuffer(numFrames:int):void {
        	super.fillOutputBuffer(numFrames);
        	trace("sourceOut : " + _sourcePosition);
        } */
